...
import CaroiuselImage from "@/components/getPost/Carousel";

export default function ImageGallery({images,imageNames}: {images: string[], imageNames: string[]}) {
  ...
  return (
    <>
      <Card
        className="h-[35rem] w-3/4 my-4 cursor-pointer overflow-hidden"
        onClick={handleOpen}
