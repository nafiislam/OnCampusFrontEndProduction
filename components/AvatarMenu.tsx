...
import keycloakSessionLogOut from "../client_actions/logout";
  ...
  return (
    <Menu>
      ...
      <MenuList placeholder={undefined}>
        <MenuItem className="flex items-center gap-2" placeholder={undefined} onClick={()=>{
