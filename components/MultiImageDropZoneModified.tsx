...
const variants = {
    ...
    image:
        'border-0 p-0 w-full h-full relative shadow-md bg-slate-200 dark:bg-slate-900 rounded-full',
    active: 'border-2',
    disabled:
...
const MultiImageDropzoneModified = React.forwardRef<HTMLInputElement, InputProps>(
    (
...
MultiImageDropzoneModified.displayName = 'MultiImageDropzoneModified';
...
export { MultiImageDropzoneModified as MultiImageDropzone };
